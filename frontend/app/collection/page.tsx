...
export default function CollectionPage() {
  ...
  // Stabilize weaponIds array to prevent infinite re-renders
  const stableWeaponIds = useMemo(() => weaponIds || [], [weaponIds]);

  // Fetch actual weapon data with metadata
  const { weapons, isLoading, error, failedCount } = useMultipleWeaponsData(stableWeaponIds);
    ...
    return (
      <main className="min-h-screen">
        ...
        <div className="container mx-auto px-4 py-16 text-center">
          <div className="rounded-full h-12 w-12 border-b-2 border-amber-500 mx-auto"></div>
        </div>
      </main>
    );
  }
